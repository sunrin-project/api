...
def insert_meal(new_meal: NewDate, db: Session):
    if new_meal.existence == True and new_meal.rest == True:
        raise HTTPException(status_code=400, detail='existence (true) and rest (true) is not available.')
